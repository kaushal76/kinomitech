                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="address-line-1" type="text" class="form-control" name="address-line-1" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="phone-cc" class="col-md-4 control-label">County Code</label>

                            <div class="col-md-6">
                                <input id="phone-cc" type="text" class="form-control" name="phone-cc" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="lang-pref" class="col-md-4 control-label">Lanuage</label>

                            <div class="col-md-6">
                                <input id="lang-pref" type="text" class="form-control" name="lang-pref" required>
                            </div>
                        </div>
